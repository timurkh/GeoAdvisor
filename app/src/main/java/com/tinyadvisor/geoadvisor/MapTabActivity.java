...
public class MapTabActivity extends Activity implements
        ConnectionCallbacks,
    ...
    private void updateValuesFromBundle(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            // Check savedInstanceState to see if the address was previously requested.
            if (savedInstanceState.keySet().contains(ADDRESS_REQUESTED_LOCATION_KEY)) {
                mAddressRequestedLocation = savedInstanceState.getParcelable(ADDRESS_REQUESTED_LOCATION_KEY);
            }
    ...
    protected void startIntentService() {
        ...
        mAddressRequestedLocation = mCurrentLocation;
        ...
        switch (status.getStatusCode()) {
            ...
            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                ...
                try {
                    ...
                    // in onActivityResult().
                    status.startResolutionForResult(MapTabActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        savedInstanceState.putParcelable(ADDRESS_REQUESTED_LOCATION_KEY, mAddressRequestedLocation);
    ...
    protected void updateMap() {
        ...
        if(!mAddressRequested)
            if (mAddressRequestedLocation == null || (mAddressRequestedLocation.distanceTo(mCurrentLocation) > Constants.DISTANCE_TO_UPDATE_MAP))
                startIntentService();
    }
